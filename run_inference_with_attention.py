...
def create_attention_visualizations(model, feats, coords, args, results):
    ...
    attention_weights = attention_data['attention_weights'][0].cpu().numpy()  # Float16 is numpy-compatible
    combined_attention = attention_data['combined_attention'][0].cpu().numpy()  # Float16 is numpy-compatible
